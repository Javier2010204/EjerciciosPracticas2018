...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.out.println("Con cuantos alumnos desea iniciar el programa?");
		...
		do {
			...
			switch (Leer.datoInt()) {
				...
				case 3: //Mostrar un alumno
					System.out.println("�Qu� alumno desea mostrar?");
					aux = 1;
					for (Alumno alumno : listaAlumnos) {
				...
				case 4: //Modificar alumnos
					System.out.println("�Qu� alumno desea eliminar?");
					aux = 1;
					for (Alumno alumno : listaAlumnos) {
						System.out.println(aux+ ".- " + alumno.getNombre());
						aux++;
